...
export const queryKeys = {
  ...
  jobReviews: (jobId: string) => ['reviews', 'job', jobId] as const,
  myInvites: ['invites', 'mine'] as const,
  jobInvites: (jobId: string) => ['invites', jobId] as const,
  userNoShows: (id: string) => ['noShows', id] as const,
  allNoShows: ['noShows', 'all'] as const,
