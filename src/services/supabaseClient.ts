 ...
 * the device's encrypted Keychain/Keystore (see lib/secureStorage.ts), not
 * plain AsyncStorage — a stolen or jailbroken device shouldn't be able to
 * read another user's session token off disk.
 */
